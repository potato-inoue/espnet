...
# ASR-train & GT-Decode (GT-text:TTS)
# ./run_offline.sh 8 10 "1089" 10 10 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 8 10 "2300"  7  7 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 8 10 "8230"  6  6 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 8 10 "237"  15 15 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 8 10 "4446" 18 18 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 8 10 "5683" 10 10 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# GT-train & GT-Decode (GT-text:TTS)
./run_offline.sh 9 10 "1089" 10 10 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
./run_offline.sh 9 10 "2300"  7  7 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
...
# for x in 1089 2300 8230 237 4446 5683; do
#     grep Avg exp/tts/test_clean_asr_no_0rec_22050_${x}_train_no_dev_pytorch_tts_train_pytorch_transformer.fine-tuning.spk${x}_lr1e-1.rev2/outputs_model.last1.avg.best_tts_decode.fine-tuning_denorm.ob_eval/librispeech.transformer.ngpu4_asr.result.v2/test_clean_adapt_no_0rec_22050_${x}_eval/result.txt | awk '{for(i=1;i<NF;i++){printf("%s ",$i)}}END{printf("\n")}'
# done
...
# ----------------stage 13 ----------------
# 0th-eval (GT-text:TTS)
# ./run_offline.sh 13 13 "1089" 10 10  ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "2300"  7  7  ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "8230"  6  6  ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "237"  15 15  ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "4446" 18 18  ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "5683" 10 10  ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ASR-eval (GT-text:TTS)
# ./run_offline.sh 13 13 "1089" 10 10 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "2300"  7  7 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# ./run_offline.sh 13 13 "8230"  6  6 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
...
# ./run_offline.sh 13 13 "5683" 10 10 ${ASR_VC} ${GT_TTS} ${GT_TTS} #@ gss(x),abelab(o)
# GT-eval (GT-text:TTS)
# ./run_offline.sh 13 13 "1089" 10 10 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 13 13 "2300"  7  7 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 13 13 "8230"  6  6 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 13 13 "237"  15 15 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 13 13 "4446" 18 18 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
# ./run_offline.sh 13 13 "5683" 10 10 ${GT_TTS} ${GT_TTS} ${GT_TTS} #@ gss(o),abelab(x)
