...
dir="exp/tts/${ex_set}_22050_${spk}_train_no_dev_pytorch_tts_train_pytorch_transformer.fine-tuning.spk${spk}_lr1.rev1/outputs_model.loss.best_tts_decode.fine-tuning_denorm/${ex_set}_22050_${spk}_eval/wav/"
