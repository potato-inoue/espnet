...
# train_config=conf/tuning/train_rnn_v2.yaml 
# train_config=conf/tuning/train_pytorch_transformer_lr5.0_ag8.v2.yaml 
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    tr_json=${feat_tr_dir}/data_wo_xvec.json
    dt_json=${feat_dt_dir}/data_wo_xvec.json
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    for rtask in  ${eval_set}; do # ${dev_set}; do
    (
        # decode_dir=decode_${rtask}_$(basename ${decode_config%.*}) #_${lmtag}
        decode_dir=decode_libritts_${rtask}_$(basename ${decode_config%.*})
        # if [ ${use_wordlm} = true ]; then
        #     recog_opts="--word-rnnlm ${lmexpdir}/rnnlm.model.best"
        # else
        #     recog_opts="--rnnlm ${lmexpdir}/rnnlm.model.best"
        # fi
        feat_recog_dir=${dumpdir}/${rtask}_22050
        # feat_recog_dir=/work/abelab/k_inoue/espnet_work_tree/libritts_22050hz/egs/libritts/tts1/dump/${rtask}
