...
resume_asr=""        # Resume the training from snapshot
...
# asr config files
# train_config_asr=model/asr_large/conf/tuning/train_pytorch_transformer_large_ngpu4.yaml
# decode_config_asr=model/asr_large/conf/tuning/decode_pytorch_transformer_large.yaml
train_config_asr=model/asr/conf/tuning/train_pytorch_transformer_lr5.0_ag8.v2.yaml
decode_config_asr=model/asr/conf/tuning/decode_pytorch_transformer.yaml
